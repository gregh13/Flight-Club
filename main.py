...
class User(UserMixin, db.Model, Base):
    ...
    quote_string = db.Column(db.String(300))
...
class Destinations(db.Model, Base):
    ...
    city1 = db.Column(db.String(200))
    price1 = db.Column(db.Integer)
    city2 = db.Column(db.String(200))
    price2 = db.Column(db.Integer)
    city3 = db.Column(db.String(200))
    price3 = db.Column(db.Integer)
    city4 = db.Column(db.String(200))
    price4 = db.Column(db.Integer)
    city5 = db.Column(db.String(200))
    price5 = db.Column(db.Integer)
    city6 = db.Column(db.String(200))
    price6 = db.Column(db.Integer)
    city7 = db.Column(db.String(200))
    price7 = db.Column(db.Integer)
    city8 = db.Column(db.String(200))
    price8 = db.Column(db.Integer)
    city9 = db.Column(db.String(200))
    price9 = db.Column(db.Integer)
    city10 = db.Column(db.String(200))
